...
func TestPublisherIndex(t *testing.T) {
	...
	h := server.NewHandler(st, newMockCovers(), discardLog, nil)
...
func TestCoverServedFromDiskCache(t *testing.T) {
	...
	h := server.NewHandler(st, covers, discardLog, nil)
...
func TestCoverUpstreamError(t *testing.T) {
	...
	h := server.NewHandler(newStore(t), covers, discardLog, nil)
...
func TestStoreImplementsInterface(t *testing.T) {
	...
	_ = server.NewHandler(st, newMockCovers(), discardLog, nil)
	if st == nil {
